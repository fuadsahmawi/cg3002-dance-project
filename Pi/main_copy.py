...
##    numbyte = 0;
##    while not numbyte > 53: 
##        numbyte = serial.in_waiting
##        print("numbytes: " + str(numbyte))
...
# poll port for data packet (pre-defined format)
while True:
    packet = read_packet(ser)
    if not isinstance(packet, int): # in effect, if read_packet() does not return -1 or -2 or an integer indicating error
    ...
    # else:
    #     print(packet)
    #     # TODO: save data as csv file
    #     # TODO: pass data to machine learning thread
